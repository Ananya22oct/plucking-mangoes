...
function setup() {
	...
	mango2 = new Mango(820,250,30);
	mango3 = new Mango(800,200,30);
	mango4 = new Mango(890,300,30);
	mango5 = new Mango(800,300,30);
	mango6 = new Mango(800,300,30);
  mango7 = new Mango(820,280,30);
    stone=new Stone(500,400,20);
    ground=new Ground(500,590,1000,20);
    tree=new Tree(810,400);
    
  boy=new Boy(220,510,250,250)
